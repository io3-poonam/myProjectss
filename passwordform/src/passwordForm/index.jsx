        ...
        <form>
          {/* <!-- section first start --> */}
            ...
            <div className="Header_mid_Section">
              ...
              <h3 className="Passport_details_header">
                ...
                filling the form. Furnishing of incorrect information/
                suppression of information would lead to rejection of
                application and would attract penal provisions as prescribed
                under the Passports Act, 1967. Please produce your original
                documents at the time of submission of the form. All fields
                marked with (*) are mandatory to fill
              </h3>
            </div>
          </div>
          {/* </section> */}
          ...
          <form>
            <div className="nameSectionForm">
              ...
              <select id="nameSection" className="select-1 inputField">
                <option value=""></option>
            ...
            <div className="nameSectionForm">
              <div className="nameSectionApp">
                <label className="label">
                  Type of Application <span>*</span>
                </label>
              </div>
              <div className="RadioSectionForm">
                <div className="">
                  <input
                    type="radio"
                    id="normal"
          ...
          <label className="label">
            Applicant's Given Name (Given Name means First Name followed by
            middle Name (if any))
            <span>*</span>
          </label>
          <br />
          ...
          <input type="radio" id="yes" name="othersName" required />
          <label >Yes</label>
          <input type="radio" id="no" name="othersName" required />
          <label >No</label>
          <br />
          <label className="label">
            Have you ever changed your name ? <span>*</span>
          </label>
          <input type="radio" id="" name="changeName" required />
          <label >Yes</label>
          <input type="radio" id="no" name="changeName" required />
          <label >No</label>
          <br />
          <label  className="label">
          ...
          <input type="text" required size="50" />
          <br />
          <label className="label" >
          ...
          >
            ...
            >
              Owners, Partners & Directors of companies which are members of
              CII, FICCI & ASSOCHAM{" "}
            </option>
          ...
          <input type="text" id="Visible" required />
          <br />
          <label className="label">
            Aadhaar Number<span>*</span>
          </label>
          <input type="text" id="Aadhaar" required maxLength="12" />
          <div className="border-part">
            <p>
              ...
              Fingerprint/Iris for authentication with UIDAI. I have no
              objection using my identity and biometric information for
              validation with Aadhaar (CIDR) database only for the purpose of
              authentication.
            </p>
            I agree
          ...
          <h4 className="heading-3 ">
            Family Details (Father/Mother/Legal Guardian details; at least one
            is mandatory.) *
          </h4>
          <label className="label">
          ...
          <br />
          <label className="label" >            Do you have a Permanent Address? <span>*</span>
          </label>
          <input
            type="radio"
          ...
          <label  className="margin-between">
            Details Available
          </label>
          <input type="radio" id="IC" name="IC" required />
          <label >
          ...
          <input type="radio" id="ICNot" name="ICNot" required />
          <label >Yes</label>
          <input type="radio" id="ICNot" name="ICNot" required />
          <label >No</label>
          <br />
          <div>
            ...
            >
              ...
              <div className="condition">
                <div className="para1">
                  <p className="con-Para">
                    Has any warrant or summons for your appearance been issued
                    and pending before a court under any law for the time being
                    in force?<span>*</span>
                  </p>
                </div>
                <div className="radio">
              ...
              <div className="condition">
                <div className="para1">
                  <p className="con-Para-1">
                    Has a warrant for your arrest been issued by a court under
                    any law for the time being in force?<span>*</span>
                  </p>
                </div>
              ...
              <div className="condition">
                <div className="para1">
                  <p className="con-Para">
                    ...
                    convicted by a court in India for any offence involving
                    moral turpitude and sentenced in respect thereof to
                    imprisonment for not less than two years?<span>*</span>
                  </p>
                </div>
                <div className="radio">
                  Yes
            ...
            >
              ...
              >
                <div className="para1">
                  <p className="con-Para-3">
                    Have you ever held the passport of any other region/country
              ...
              >
                <div className="para1">
                  <p className="con-Para-3">
                    Have you ever applied for renunciation of Indian
            ...
            >
              <h4 className="">
                5 Provide the following details if applicant has returned to
                India on Emergency Certificate.
              </h4>

              <div className="">
                <div className="para1">
                  <p className="con-Para-3">
                    Have you ever returned to India on Emergency Certificate
                    (EC) ?<span>*</span>
                  </p>
                </div>
                <div className="radio-3">
              ...
              >
                ...
                <div className="radio-3">
                  Yes
                  <input type="radio" name="8point" required />
                  No
                  <input type="radio" name="8point" required />
                </div>
              </div>
              ...
              >
                <div className="para1">
                  <p className="con-Para-3">
                    Have you ever been repatriated from any country back to
                    India?<span>*</span>
                  </p>
                </div>
                <div className="radio-3">
          ...
          <div className="last-div">
            ...
            <p>
              ...
              deprived of the citizenship of India. I have not contravened any
              of the conditions relating to the possession and use of an Indian
              passport
            </p>
            <p>
              I affirm that the information and particulars given by me in this
              form are true and correct. I further state that I am not
              suppressing any material information in this regard. I further
              affirm that the enclosures and documentary proof submitted in
              support of my application for an Indian passport are authentic and
              solely pertain to me and I am fully responsible for the accuracy
              of the same. I am liable to be penalized or prosecuted if found
          ...
          <p>
            Applicants are required to submit the proof of address of the
            present address only, irrespective of the date from which he/she has
            been residing at the given address.
          </p>
